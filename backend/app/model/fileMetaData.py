class FileMetadata:
    ...
    def __init__(self, full_unc_path, file_path, file_name, shared_folder_name, file_size, is_file, host, host_ip, host_name=""):
        ...
        self.host_ip = host_ip                 # IP of the file (name of pc which contains file)
        self.host_name = host_name             # Host name of the machine
